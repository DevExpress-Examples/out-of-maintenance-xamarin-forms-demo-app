...
namespace DemoCenter.Forms.Views {
    public partial class DrawerMailBoxView : ContentPage {
        public DrawerMailBoxView() {
            ...
            bindingContext.PropertyChanged += (object sender, System.ComponentModel.PropertyChangedEventArgs e) => {
                pageDrawer.IsDrawerOpened &= e.PropertyName != nameof(DrawerMailBoxViewModel.SelectedFolder);
            };

            BindingContext = bindingContext;
        }

        void OnMenuClicked(object sender, EventArgs args) => pageDrawer.IsDrawerOpened = true;
    }
}
